...
export const Discuss = component$(() => {
  const state = useStore({ slider: {} });

  useVisibleTask$(() => {
    console.log("useVisibleTask work");

    state.slider = new Splide(".splide", {
      trimSpace: "move",
      focus: "center",
      perPage: 3,
      isNavigation: true,
  ...
  return (
    <section
      ...
      class="splide visible discuss bg-dark pt-[62px] pb-[80px] lg:pt-[65px] lg:pb-[80px] xl:pt-[47px] xl:pb-[41px] 2xl:pt-[110px] 2xl:pb-[41px]"
